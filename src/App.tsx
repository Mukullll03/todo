    ...
    <div className="max-w-6xl mx-auto px-4 py-8 md:py-12 border-x border-slate-200 min-h-screen bg-white">
      ...
      <header className="mb-8 md:mb-12 border-b border-slate-200 pb-6 md:pb-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-8">
          ...
          <div className="glass p-3 sm:p-4 md:p-6 rounded-xl sm:rounded-2xl md:rounded-3xl border-slate-200 shadow-xl shadow-slate-100 flex flex-col lg:flex-row items-center lg:items-center lg:justify-between gap-3 sm:gap-4 md:gap-6 w-full">
            <div className="flex-1 lg:flex-none flex items-center gap-3 sm:gap-4 md:gap-6 min-w-0 w-full lg:w-auto">
            ...
            <div className="flex items-center gap-1 sm:gap-2 flex-wrap lg:w-auto">
