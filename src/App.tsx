    ...
    <div className="max-w-6xl mx-auto px-4 py-8 md:py-12 border-x border-slate-200 min-h-screen bg-white">
      ...
      <header className="mb-8 md:mb-12 border-b border-slate-200 pb-6 md:pb-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-8">
          ...
          <div className="glass p-4 md:p-6 rounded-xl sm:rounded-2xl md:rounded-3xl border-slate-200 shadow-xl shadow-slate-100 w-full">
            <div className="flex items-center gap-1 sm:gap-2 mb-3 md:mb-4 flex-wrap">
              <p className="text-slate-400 text-[9px] sm:text-[10px] font-bold uppercase tracking-widest">Syllabus Progress</p>
              {currentStreak > 0 && (
            ...
            <div className="flex items-center gap-4 md:gap-6">
              <div className="relative w-20 h-20 flex-shrink-0">
                ...
                <div className="absolute inset-0 flex items-center justify-center font-bold text-base md:text-xl text-slate-900">{percentage}%</div>
              </div>
