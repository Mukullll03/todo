          ...
          <div className="glass p-2 sm:p-3 md:p-6 rounded-lg sm:rounded-xl md:rounded-2xl border-slate-200 shadow-xl shadow-slate-100 w-full md:w-auto md:min-w-fit">
            <div className="flex items-center gap-2 sm:gap-3 md:gap-6">
              ...
              <div className="relative w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 flex-shrink-0">
                ...
                <div className="absolute inset-0 flex items-center justify-center font-bold text-xs sm:text-sm md:text-xl text-slate-900">{percentage}%</div>
              </div>
              ...
              <div className="flex flex-col gap-0.5 sm:gap-1 md:gap-2">
                ...
                <p className="text-[10px] sm:text-xs md:text-lg font-black text-slate-900 leading-tight">{completedCount} of {totalTasksCount} topics mastered</p>
                {currentStreak > 0 && (
                  <span className="flex items-center gap-0.5 bg-orange-100 text-orange-600 px-1.5 py-0.5 rounded-full text-[7px] sm:text-[8px] font-black w-fit mt-0.5">
